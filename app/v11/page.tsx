    ...
    <div className="overflow-hidden rounded-2xl shadow-2xl" style={{ background: c.bg, border: `1px solid ${c.border}`, width: "360px", maxWidth: "100%", transition: "background 0.3s, border-color 0.3s" }}>
      ...
      <div className="flex items-center gap-3 border-b px-5 py-4" style={{ borderColor: c.headerBorder }}>
        ...
        <div>
          ...
          <p className="text-[11px]" style={{ color: c.mutedText }}>Powered by neatr.ai</p>
        </div>
      </div>
  ...
  return (
    <nav className="fixed inset-x-0 top-0 z-50 transition-all duration-300" style={{
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        <a href="/" style={{ fontFamily: "system-ui", fontWeight: 700, fontSize: "15px", letterSpacing: "-0.02em", color: dk ? "#F9FAFB" : "#111827" }}>[neatr.ai]</a>
          ...
          <div>
            ...
            <Reveal delay={180}>
              <p className="mt-7 max-w-md text-lg leading-[1.8]" style={{ color: dk ? "rgba(255,255,255,0.55)" : "#6B7280" }}>
                neatr.ai puts a self-booking assistant on your website. Customers pick their own slot, AI answers their questions, and the booking lands in your dashboard — without a single call.
              </p>
            </Reveal>
    ...
    <section id="how" className="py-28" style={{ background: "#F9FAFB" }}>
      <div className="mx-auto max-w-5xl px-6">
        <Reveal className="mb-14 text-center">
          <p className="mb-3 text-sm font-semibold" style={{ color: "#2563EB" }}>Before neatr.ai</p>
          ...
          <p className="mx-auto mt-4 max-w-sm text-base" style={{ color: "#6B7280" }}>Here&apos;s the sequence every service business knows by heart — and how neatr.ai replaces it.</p>
        </Reveal>
      ...
      <div className="mx-auto max-w-2xl px-6 text-center">
        <Reveal>
          ...
          <p className="mx-auto mt-7 max-w-lg text-base leading-[1.8]" style={{ color: "rgba(255,255,255,0.50)" }}>
            neatr.ai is new. We&apos;re looking for cleaning and home services businesses who are tired of booking calls — and willing to work closely with us.
          </p>
        ...
        <Reveal delay={140}>
          <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            ...
            <a href="mailto:hello@neatr.ai" className="rounded-xl border px-8 py-4 text-sm font-medium transition-colors" style={{ borderColor: "rgba(255,255,255,0.14)", color: "rgba(255,255,255,0.55)" }}>
              Email us directly
            </a>
          </div>
        </Reveal>
  ...
  return (
    <footer className="border-t py-10" style={{ background: "#FFFFFF", borderColor: "#F3F4F6" }}>
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-6 md:flex-row">
        <p style={{ fontFamily: "system-ui", fontWeight: 700, fontSize: "14px", letterSpacing: "-0.01em", color: "#111827" }}>[neatr.ai]</p>
        ...
        <div className="flex gap-5 text-xs" style={{ color: "#9CA3AF" }}>
          {[["Privacy", "#"], ["Terms", "#"], ["hello@neatr.ai", "mailto:hello@neatr.ai"]].map(([l, h]) => (
