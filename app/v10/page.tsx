      ...
      <div className="mx-auto max-w-4xl px-6">
        <Reveal>
          ...
          <p className="mx-auto mt-8 max-w-xl text-[15px] leading-relaxed" style={{ color: "#787068" }}>
            The difference isn&apos;t a feature list. It&apos;s that ServiceOS will do the actual work — dispatching, rerouting, repricing, following up — so you stop managing software and start running a business.
          </p>
        </Reveal>
      </div>
    </section>
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        <Reveal className="mb-16 max-w-2xl">
          ...
          <p className="mt-6 text-base" style={{ color: "rgba(255,255,255,0.48)" }}>
            While you&apos;re running the business, ServiceOS is running the software. Here&apos;s exactly how.
          </p>
        </Reveal>
    ...
    <section className="overflow-hidden py-32" style={{ background: "#FFFFFF" }}>
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
          <Reveal delay={60}>
            <AppFrame src="/assets/v6-overview.png" alt="ServiceOS operations overview dashboard" url="book.everneat.co/dashboard" />
          </Reveal>
          <Reveal delay={120}>
        ...
        <div className="mt-24 grid gap-16 lg:grid-cols-2 lg:items-center">
          ...
          <Reveal delay={120} className="order-1 lg:order-2">
            <AppFrame src="/assets/v6-calendar.png" alt="ServiceOS AI scheduling calendar" url="book.everneat.co/schedule" />
          </Reveal>
        </div>
      </div>
    </section>
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        <Reveal>
          ...
          <h2 style={{ fontFamily: "var(--font-dm-sans), system-ui", fontWeight: 700, letterSpacing: "-0.045em", lineHeight: 1.0, color: "#080808", fontSize: "clamp(2.8rem, 7vw, 6rem)" }}>
            Be one of the first<br />100 businesses<br /><span style={{ fontFamily: "var(--font-cormorant), Georgia, serif", fontWeight: 300, fontStyle: "italic", color: "rgba(8,8,8,0.65)", fontSize: "clamp(2.2rem, 5.5vw, 4.8rem)" }}>to shape ServiceOS.</span>
          </h2>
