        ...
        <div style={{ maxWidth:800, margin:"0 auto", textAlign:"center" }}>
          ...
          <Reveal delay={60}>
            <blockquote style={{ fontSize:"clamp(20px,2.5vw,28px)", fontWeight:500, lineHeight:1.45, letterSpacing:"-0.02em", margin:"0 0 36px", color:L.text }}>
              &ldquo;We went from managing bookings in a Google Sheet to having 40+ recurring customers managed automatically. Everneat paid for itself in the first week.&rdquo;
            </blockquote>
          </Reveal>
          <Reveal delay={100}>
