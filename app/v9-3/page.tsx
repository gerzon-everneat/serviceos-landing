...
/* ─── v9.3: "5-star reputation" — customer experience & reviews angle ─────── */
...
const IconStar    = () => (<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" /></svg>);
const IconRepeat  = () => (<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M17 1l4 4-4 4" /><path d="M3 11V9a4 4 0 0 1 4-4h14" /><path d="M7 23l-4-4 4-4" /><path d="M21 13v2a4 4 0 0 1-4 4H3" /></svg>);
        ...
        <div>
          <Reveal>
            <div className="mb-8 inline-flex items-center gap-2 rounded-full border px-3.5 py-1.5 text-[11px]" style={{ borderColor: "rgba(184,146,42,0.30)", background: "rgba(184,146,42,0.06)", color: "#B8922A" }}>
              <span className="h-1.5 w-1.5 rounded-full bg-current" /> Built for 5-star service brands
            </div>
          </Reveal>
          ...
          <h1 className="animate-rise-1" style={{
            ...
            5 stars.<br />
            Every job.<br />
            <span style={{ color: "#B8922A" }}>On autopilot.</span>
          </h1>

          <Reveal delay={150}>
            <p className="mt-9 max-w-md text-base leading-[1.85]" style={{ color: "rgba(255,255,255,0.50)" }}>
              neaterops makes every customer experience seamless — right pro, on time, followed up perfectly. Reviews write themselves. Customers come back. Your reputation compounds.
            </p>
          </Reveal>

          <Reveal delay={240}>
            <div className="mt-8 flex flex-wrap gap-4">
              <a href="#" className="rounded-md px-7 py-3.5 text-sm font-semibold transition-all hover:opacity-90 hover:shadow-lg" style={{ background: "#ffffff", color: "#080808" }}>Build your reputation →</a>
              <a href="#ai" className="flex items-center gap-2 rounded-md border px-6 py-3.5 text-sm transition-colors hover:border-white/25" style={{ border: "1px solid rgba(255,255,255,0.13)", color: "rgba(255,255,255,0.65)" }}>See the CX engine</a>
            </div>
          </Reveal>
      ...
      <div className="mx-auto max-w-4xl px-6">
        <Reveal>
          ...
          <p className="mx-auto mt-8 max-w-xl text-[15px] leading-relaxed" style={{ color: "#787068" }}>
            Customers judge your business before the team arrives. A clunky booking flow — back-and-forth calls, unclear pricing, slow confirmation — already costs you stars. neaterops gives customers a fast, clear, professional booking experience that sets the right expectation from the start.
          </p>
        </Reveal>
      </div>
    </section>
      ...
      <div className="mx-auto max-w-6xl px-6">
        <Reveal className="mb-14 text-center">
          ...
          <h2 style={{ fontFamily: "var(--font-dm-sans), system-ui", fontWeight: 700, letterSpacing: "-0.045em", lineHeight: 0.95, color: "#141210", fontSize: "clamp(2.8rem, 6.5vw, 5.5rem)" }}>
            Your brand.<br />
            <span style={{ fontFamily: "var(--font-cormorant), Georgia, serif", fontWeight: 300, fontStyle: "italic", color: "#B8922A", fontSize: "clamp(2.4rem, 5.5vw, 4.8rem)" }}>Premium by default.</span>
          </h2>
          <p className="mx-auto mt-6 max-w-lg text-[15px] leading-relaxed" style={{ color: "#787068" }}>
            Every customer touchpoint is polished, proactive, and on-brand — from booking confirmation to post-job follow-up.
          </p>
        </Reveal>
        <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
          <Reveal delay={60}>
            <AppFrame src="/assets/v6-overview.png" alt="Everneat customer experience dashboard" url="book.everneat.co/dashboard" />
          </Reveal>
          <Reveal delay={120}>
            <div className="space-y-6">
              <div>
                <h3 style={{ fontFamily: "var(--font-dm-sans)", fontWeight: 700, fontSize: "clamp(1.4rem, 2.5vw, 2rem)", letterSpacing: "-0.03em", color: "#141210", lineHeight: 1.1 }}>
                  Your reviews.<br />
                  <span style={{ color: "#B8922A" }}>Tracked in real time.</span>
                </h3>
                <p className="mt-4 text-[15px] leading-relaxed" style={{ color: "#787068" }}>
                  See your review capture rate, rebooking stats, and top-performing pros — all in one dashboard that tells you exactly how your reputation is growing.
                </p>
              </div>
              {[
                { label: "Review rate dashboard", desc: "Track reviews per job, per week, per pro — and see what drives them." },
                { label: "Customer satisfaction score", desc: "Rolling NPS and review trends. Know where you stand." },
                { label: "Rebooking conversion", desc: "See which customers are ready to rebook and which need a nudge." },
              ].map((item) => (
        ...
        <div className="mt-24 grid gap-16 lg:grid-cols-2 lg:items-center">
          <Reveal delay={60} className="order-2 lg:order-1">
            <div className="space-y-6">
              <div>
                <h3 style={{ fontFamily: "var(--font-dm-sans)", fontWeight: 700, fontSize: "clamp(1.4rem, 2.5vw, 2rem)", letterSpacing: "-0.03em", color: "#141210", lineHeight: 1.1 }}>
                  The right pro.<br />
                  <span style={{ color: "#B8922A" }}>Every single time.</span>
                </h3>
                <p className="mt-4 text-[15px] leading-relaxed" style={{ color: "#787068" }}>
                  AI matches each booking to the best-rated available pro — and wherever possible, the same person your customer loved last time.
                </p>
              </div>
              {[
                { label: "Preferred provider matching", desc: "Returning customers get the same great team member by default." },
                { label: "Skill-based routing", desc: "Right job, right person. Every speciality matched accurately." },
                { label: "On-time delivery tracking", desc: "Monitor punctuality and flag before it becomes a review." },
              ].map((item) => (
                <div key={item.label} className="flex gap-3">
                  <div className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full" style={{ background: "#B8922A" }} />
                  <div>
          ...
          <Reveal delay={120} className="order-1 lg:order-2">
            <AppFrame src="/assets/v6-calendar.png" alt="Everneat customer experience scheduling" url="book.everneat.co/schedule" />
          </Reveal>
        </div>
      </div>
    </section>
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        <Reveal className="mb-16 text-center">
          ...
          <h2 style={{ fontFamily: "var(--font-dm-sans), system-ui", fontWeight: 700, letterSpacing: "-0.045em", lineHeight: 0.95, color: "#FFFFFF", fontSize: "clamp(2.8rem, 6vw, 5rem)" }}>
            Customers who love you<br /><span style={{ color: "#B8922A" }}>come back. And tell people.</span>
          </h2>
        </Reveal>
...
const FEATURES = [
  { icon: <IconCode />,      title: "Booking Widget",         desc: "A seamless booking flow on your site — fast, mobile-friendly, and on-brand. First impressions matter.", tag: "Customer" },
  { icon: <IconMsg />,       title: "Automated Comms",        desc: "Confirmation, reminder, follow-up, review nudge — all personalised, all automatic, all on time.",       tag: "CX" },
  { icon: <IconStar />,      title: "Review Capture",         desc: "AI spots the optimal post-job window and sends a nudge that converts. 89% capture rate on average.",    tag: "Reviews" },
  { icon: <IconRepeat />,    title: "Rebooking Autopilot",    desc: "Customers get a personalised nudge at exactly the right time. 71% rebook within 60 days.",              tag: "Retention" },
  { icon: <IconUsers />,     title: "Customer Portal",        desc: "Clients self-serve: book, reschedule, track status, view history. A premium experience they remember.",  tag: "Customers" },
  { icon: <IconPhone />,     title: "Pro Field Portal",       desc: "Your crew shows up informed — job details, customer notes, and history in their pocket.",                tag: "Staff" },
];
      ...
      <div className="mx-auto max-w-6xl px-6">
        <Reveal className="mb-14">
          ...
          <h2 style={{ fontFamily: "var(--font-dm-sans), system-ui", fontWeight: 700, letterSpacing: "-0.045em", lineHeight: 0.95, color: "#141210", fontSize: "clamp(2.8rem, 6.5vw, 5rem)" }}>
            Every touchpoint.<br /><span style={{ color: "#B8922A" }}>Always perfect.</span>
          </h2>
        </Reveal>
            ...
            <Reveal key={i} delay={i * 55}>
              <div className="shimmer-card group h-full rounded-2xl border p-7 transition-all duration-300 hover:-translate-y-1 hover:shadow-md hover:shadow-black/[0.05]" style={{ background: "#FFFFFF", borderColor: "#E5E0D8" }}>
                <div className="flex items-center justify-between mb-5">
                  ...
                  <span className="rounded-full border px-2.5 py-1 text-[10px]" style={{ borderColor: ["CX","Reviews","Retention"].includes(f.tag) ? "rgba(184,146,42,0.30)" : "#E5E0D8", color: ["CX","Reviews","Retention"].includes(f.tag) ? "#B8922A" : "#787068" }}>{f.tag}</span>
                </div>
      ...
      <div className="mx-auto max-w-6xl px-6">
        <Reveal className="mb-12 text-center">
          ...
          <h2 style={{ fontFamily: "var(--font-dm-sans), system-ui", fontWeight: 700, letterSpacing: "-0.045em", lineHeight: 0.95, color: "#141210", fontSize: "clamp(2.8rem, 6vw, 5rem)" }}>
            The reviews pay<br /><span style={{ fontFamily: "var(--font-cormorant), Georgia, serif", fontWeight: 300, fontStyle: "italic", color: "#B8922A", fontSize: "clamp(2.4rem, 5vw, 4.2rem)" }}>for themselves.</span>
          </h2>
  ...
  return (
    <section className="relative overflow-hidden py-32" style={{ background: "#C8FF00" }}>
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        <Reveal>
          <p className="mb-5 text-[10px] font-medium uppercase tracking-[0.3em]" style={{ color: "rgba(8,8,8,0.50)" }}>Build your reputation</p>
          <h2 style={{ fontFamily: "var(--font-dm-sans), system-ui", fontWeight: 700, letterSpacing: "-0.045em", lineHeight: 1.0, color: "#080808", fontSize: "clamp(2.8rem, 7vw, 6rem)" }}>
            Turn every booking<br />into a 5-star review.<br /><span style={{ fontFamily: "var(--font-cormorant), Georgia, serif", fontWeight: 300, fontStyle: "italic", color: "rgba(8,8,8,0.65)", fontSize: "clamp(2.2rem, 5.5vw, 4.8rem)" }}>Automatically.</span>
          </h2>
          <p className="mx-auto mt-8 max-w-lg text-base" style={{ color: "rgba(8,8,8,0.58)" }}>
            Join 5,000+ service businesses building a reputation that sells itself. Start free — your first review request goes out before your first day is done.
          </p>
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <a href="#" className="rounded-md px-9 py-4 text-sm font-semibold transition-all hover:opacity-90 hover:shadow-lg" style={{ background: "#080808", color: "#ffffff" }}>Start earning 5 stars →</a>
