        ...
        <div>
          ...
          <Reveal delay={150}>
            <p className="mt-9 max-w-md text-base leading-[1.85]" style={{ color: "rgba(255,255,255,0.50)" }}>
              neatr.ai makes every customer experience seamless — right pro, on time, followed up perfectly. Reviews write themselves. Customers come back. Your reputation compounds.
            </p>
          </Reveal>
      ...
      <div className="mx-auto max-w-4xl px-6">
        <Reveal>
          ...
          <p className="mx-auto mt-8 max-w-xl text-[15px] leading-relaxed" style={{ color: "#787068" }}>
            Customers judge your business before the team arrives. A clunky booking flow — back-and-forth calls, unclear pricing, slow confirmation — already costs you stars. neatr.ai gives customers a fast, clear, professional booking experience that sets the right expectation from the start.
          </p>
        </Reveal>
      </div>
    </section>
    ...
    <section className="overflow-hidden py-32" style={{ background: "#FFFFFF" }}>
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
          <Reveal delay={60}>
            <AppFrame src="/assets/v6-overview.png" alt="neatr.ai customer experience dashboard" url="book.neatr.ai/dashboard" />
          </Reveal>
          <Reveal delay={120}>
        ...
        <div className="mt-24 grid gap-16 lg:grid-cols-2 lg:items-center">
          ...
          <Reveal delay={120} className="order-1 lg:order-2">
            <AppFrame src="/assets/v6-calendar.png" alt="neatr.ai customer experience scheduling" url="book.neatr.ai/schedule" />
          </Reveal>
        </div>
      </div>
    </section>
