        ...
        <div>
          ...
          <Reveal delay={150}>
            <p className="mt-9 max-w-md text-base leading-[1.85]" style={{ color: "rgba(255,255,255,0.50)" }}>
              ServiceOS makes every customer experience seamless — right pro, on time, followed up perfectly. Reviews write themselves. Customers come back. Your reputation compounds.
            </p>
          </Reveal>
