...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    locale: "en_US",
    images: [{ url: `${SITE}/videos/poster-03.jpg`, width: 1600, height: 900, alt: "A customer booking a cleaning on neatr" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "neatr — Bookings in. Jobs dispatched. You just grow.",
    description: "Real recordings of the live product — from sign-up to a paid booking.",
    images: [`${SITE}/videos/poster-03.jpg`],
  },
