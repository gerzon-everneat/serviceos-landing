    ...
    <section className="overflow-hidden py-32" style={{ background: "#FFFFFF" }}>
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
          <Reveal delay={60}>
            <AppFrame src="/assets/v6-overview.png" alt="Everneat operations overview dashboard" url="book.everneat.co/dashboard" />
          </Reveal>
          <Reveal delay={120}>
        ...
        <div className="mt-24 grid gap-16 lg:grid-cols-2 lg:items-center">
          ...
          <Reveal delay={120} className="order-1 lg:order-2">
            <AppFrame src="/assets/v6-calendar.png" alt="Everneat AI scheduling calendar" url="book.everneat.co/schedule" />
          </Reveal>
        </div>
      </div>
    </section>
