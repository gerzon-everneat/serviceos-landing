...
/* ─── v9.1: "For the owner doing it all" — time freedom angle ─────────────── */
...
const IconClock   = () => (<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><circle cx="12" cy="12" r="10" /><path d="M12 6v6l4 2" /></svg>);
        ...
        <div>
          <Reveal>
            <div className="mb-8 inline-flex items-center gap-2 rounded-full border px-3.5 py-1.5 text-[11px]" style={{ borderColor: "rgba(184,146,42,0.30)", background: "rgba(184,146,42,0.06)", color: "#B8922A" }}>
              <span className="h-1.5 w-1.5 rounded-full bg-current" /> Built for founder-operators
            </div>
          </Reveal>
          ...
          <h1 className="animate-rise-1" style={{
            ...
            You run<br />
            the business.<br />
            <span style={{ color: "#B8922A" }}>We run ops.</span>
          </h1>

          <Reveal delay={150}>
            <p className="mt-9 max-w-md text-base leading-[1.85]" style={{ color: "rgba(255,255,255,0.50)" }}>
              You shouldn&apos;t be the dispatcher, the scheduler, and the follow-up guy. neatr.ai takes every one of those jobs off your plate — automatically, all day, every day.
            </p>
          </Reveal>

          <Reveal delay={240}>
            <div className="mt-8 flex flex-wrap gap-4">
              <a href="#" className="rounded-md px-7 py-3.5 text-sm font-semibold transition-all hover:opacity-90 hover:shadow-lg" style={{ background: "#ffffff", color: "#080808" }}>Get your time back →</a>
              <a href="#ai" className="flex items-center gap-2 rounded-md border px-6 py-3.5 text-sm transition-colors hover:border-white/25" style={{ border: "1px solid rgba(255,255,255,0.13)", color: "rgba(255,255,255,0.65)" }}>See it in action</a>
            </div>
          </Reveal>
      ...
      <div className="mx-auto max-w-4xl px-6">
        <Reveal>
          ...
          <p className="mx-auto mt-8 max-w-xl text-[15px] leading-relaxed" style={{ color: "#787068" }}>
            Most owners spend 2–3 hours a day fielding calls from customers who just want to book, reschedule, or ask what&apos;s included. neatr.ai puts a self-serve booking flow on your site so customers handle it themselves — and your phone goes quiet.
          </p>
        </Reveal>
      </div>
    </section>
      ...
      <div className="mx-auto max-w-6xl px-6">
        <Reveal className="mb-14 text-center">
          ...
          <h2 style={{ fontFamily: "var(--font-dm-sans), system-ui", fontWeight: 700, letterSpacing: "-0.045em", lineHeight: 0.95, color: "#141210", fontSize: "clamp(2.8rem, 6.5vw, 5.5rem)" }}>
            ...
            <span style={{ fontFamily: "var(--font-cormorant), Georgia, serif", fontWeight: 300, fontStyle: "italic", color: "#B8922A", fontSize: "clamp(2.4rem, 5.5vw, 4.8rem)" }}>Running itself.</span>
          </h2>
          <p className="mx-auto mt-6 max-w-lg text-[15px] leading-relaxed" style={{ color: "#787068" }}>
            One glance. Everything handled. Your whole business, visible and automated.
          </p>
        </Reveal>
            ...
            <div className="space-y-6">
              <div>
                <h3 style={{ fontFamily: "var(--font-dm-sans)", fontWeight: 700, fontSize: "clamp(1.4rem, 2.5vw, 2rem)", letterSpacing: "-0.03em", color: "#141210", lineHeight: 1.1 }}>
                  Your whole day.<br />
                  <span style={{ color: "#B8922A" }}>At a glance.</span>
                </h3>
                <p className="mt-4 text-[15px] leading-relaxed" style={{ color: "#787068" }}>
                  See every job, every staff member, every booking — status, location, and revenue — without opening a spreadsheet or making a call.
                </p>
              </div>
              {[
                { label: "Live operations feed", desc: "Know what's happening right now without texting your team." },
                { label: "Provider load at a glance", desc: "Who's maxed, who has capacity. Instantly visible." },
                { label: "Today's revenue, live", desc: "Watch it grow as jobs complete — no end-of-day surprises." },
              ].map((item) => (
          ...
          <Reveal delay={60} className="order-2 lg:order-1">
            <div className="space-y-6">
              <div>
                <h3 style={{ fontFamily: "var(--font-dm-sans)", fontWeight: 700, fontSize: "clamp(1.4rem, 2.5vw, 2rem)", letterSpacing: "-0.03em", color: "#141210", lineHeight: 1.1 }}>
                  Scheduling runs<br />
                  <span style={{ color: "#B8922A" }}>without you.</span>
                </h3>
                <p className="mt-4 text-[15px] leading-relaxed" style={{ color: "#787068" }}>
                  Bookings route to the right person automatically. Conflicts resolve before you even know they exist. The calendar just works.
                </p>
              </div>
              {[
                { label: "Zero-touch assignment", desc: "Every booking matched to a pro the instant it's confirmed." },
                { label: "Silent conflict resolution", desc: "Rerouting happens before it becomes a problem — automatically." },
                { label: "No double-bookings, ever", desc: "Not once. The system won't allow it." },
              ].map((item) => (
                <div key={item.label} className="flex gap-3">
                  <div className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full" style={{ background: "#B8922A" }} />
                  <div>
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        <Reveal className="mb-16 text-center">
          ...
          <h2 style={{ fontFamily: "var(--font-dm-sans), system-ui", fontWeight: 700, letterSpacing: "-0.045em", lineHeight: 0.95, color: "#FFFFFF", fontSize: "clamp(2.8rem, 6vw, 5rem)" }}>
            Hours returned.<br /><span style={{ color: "#B8922A" }}>Every week.</span>
          </h2>
        </Reveal>
...
const FEATURES = [
  { icon: <IconCode />,      title: "Booking Widget",       desc: "One embed on your site. Customers book themselves — you just get the notification.", tag: "Customer" },
  { icon: <IconZap />,       title: "Smart Auto-Dispatch",  desc: "AI assigns every job instantly. You set the rules once and forget it forever.",       tag: "AI" },
  { icon: <IconPhone />,     title: "Pro Field Portal",     desc: "Your crew gets clean mobile job cards. No WhatsApp chains, no manual runsheets.",      tag: "Staff" },
  { icon: <IconUsers />,     title: "Customer Self-Serve",  desc: "Clients reschedule, track, and review without calling you. Nights and weekends included.", tag: "Customers" },
  { icon: <IconCard />,      title: "Payments & Payroll",   desc: "Stripe-powered. Invoicing, tracking, and payroll reports — generated automatically.",    tag: "Finance" },
  { icon: <IconCalendar />,  title: "Automated Reminders",  desc: "Email + SMS confirmations and follow-ups go out on their own. Zero copy-pasting.",      tag: "Automation" },
];
      ...
      <div className="mx-auto max-w-6xl px-6">
        <Reveal className="mb-14">
          ...
          <h2 style={{ fontFamily: "var(--font-dm-sans), system-ui", fontWeight: 700, letterSpacing: "-0.045em", lineHeight: 0.95, color: "#141210", fontSize: "clamp(2.8rem, 6.5vw, 5rem)" }}>
            Every task you hate.<br /><span style={{ color: "#B8922A" }}>Already automated.</span>
          </h2>
        </Reveal>
      ...
      <div className="mx-auto max-w-6xl px-6">
        <Reveal className="mb-12 text-center">
          ...
          <h2 style={{ fontFamily: "var(--font-dm-sans), system-ui", fontWeight: 700, letterSpacing: "-0.045em", lineHeight: 0.95, color: "#141210", fontSize: "clamp(2.8rem, 6vw, 5rem)" }}>
            Less than a part-time VA.<br /><span style={{ fontFamily: "var(--font-cormorant), Georgia, serif", fontWeight: 300, fontStyle: "italic", color: "#B8922A", fontSize: "clamp(2.4rem, 5vw, 4.2rem)" }}>Works 24/7.</span>
          </h2>
  ...
  return (
    <section className="relative overflow-hidden py-32" style={{ background: "#C8FF00" }}>
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        <Reveal>
          <p className="mb-5 text-[10px] font-medium uppercase tracking-[0.3em]" style={{ color: "rgba(8,8,8,0.50)" }}>Get started today</p>
          <h2 style={{ fontFamily: "var(--font-dm-sans), system-ui", fontWeight: 700, letterSpacing: "-0.045em", lineHeight: 1.0, color: "#080808", fontSize: "clamp(2.8rem, 7vw, 6rem)" }}>
            Stop being the<br />operations manager.<br /><span style={{ fontFamily: "var(--font-cormorant), Georgia, serif", fontWeight: 300, fontStyle: "italic", color: "rgba(8,8,8,0.65)", fontSize: "clamp(2.2rem, 5.5vw, 4.8rem)" }}>Just be the owner.</span>
          </h2>
          <p className="mx-auto mt-8 max-w-lg text-base" style={{ color: "rgba(8,8,8,0.58)" }}>
            Join 5,000+ owners who stopped running the ops and started running the business. Live in under an hour. No credit card needed.
          </p>
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <a href="#" className="rounded-md px-9 py-4 text-sm font-semibold transition-all hover:opacity-90 hover:shadow-lg" style={{ background: "#080808", color: "#ffffff" }}>Get your time back →</a>
