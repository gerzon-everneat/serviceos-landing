...
export const metadata: Metadata = {
  title: "neatr.ai — Online Booking System for Service Businesses",
  description: "neatr.ai is an AI-powered online booking system for cleaning, maintenance & field service businesses. Auto-dispatch jobs, resolve conflicts, collect payments, and follow up with customers — automatically.",
