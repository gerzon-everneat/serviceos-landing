...
export const metadata: Metadata = {
  title: "neaterops — Online Booking System for Service Businesses",
  description: "neaterops is an AI-powered online booking system for cleaning, maintenance & field service businesses. Auto-dispatch jobs, resolve conflicts, collect payments, and follow up with customers — automatically.",
